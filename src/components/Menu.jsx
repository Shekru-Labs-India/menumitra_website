      ...
      <div className="container">
        <div className="row v-center">
          <div className="col-lg-5">
            <img
              src="https://02adc572.rocketcdn.me/wp-content/uploads/2024/02/4-3.png"
              alt=""
            ...
            >
              <div className="accordion-item">
                ...
                >
                  <div className="accordion-body">
                    Absolutely! You have the flexibility to update your menu
                    anytime, anywhere.
                  </div>
                  {/* / accordion-body */}
                </div>
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="minimal-headingTwo">
                  ...
                  >
                    Can I add multiple price for the same item in Ciferon POS?
                    <span>
                      <i className="fas fa-chevron-down" />
                    </span>
                  </button>
                ...
                >
                  <div className="accordion-body">
                    Certainly! You can spice things up by adding multiple prices
                    for the same item. Just create different price books to make
                    it happen!
                  </div>
                  {/* / accordion-body */}
                </div>
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="minimal-headingThree">
                  ...
                  >
                    Can I manage multiple menu for my chain outlets?
                    <span>
                      <i className="fas fa-chevron-down" />
                    </span>
                  </button>
                ...
                >
                  <div className="accordion-body">
                    Absolutely! You have the power to craft multiple menus, and
                    then it’s as easy as assigning each one to its respective
                    outlet. Simple as that!
                  </div>
                  {/* / accordion-body */}
                </div>
                {/* / collapse */}
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="minimal-headingThree">
                  <button
                    ...
                    aria-controls="minimal-collapseThree"
                  >
                    Can I manage all outlets menu from my head office only?
                    <span>
                      <i className="fas fa-chevron-down" />
                    </span>
                  </button>
                ...
                >
                  <div className="accordion-body">
                    Certainly! You’re the boss even from the head office. You
                    can handle all outlet menus, and if you don’t want anyone
                    tweaking or adding stuff to their assigned menu, you’re in
                    control of that too!
                  </div>
                  {/* / accordion-body */}
                </div>
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="minimal-headingThree">
                  <button
                    ...
                    aria-controls="minimal-collapseThree"
                  >
                    Can I keep different menu for online and Dine In?
                    <span>
                      <i className="fas fa-chevron-down" />
                    </span>
                  </button>
                ...
                >
                  <div className="accordion-body">
                    Absolutely! Just by setting up multiple price books, it’s as
                    easy as that!🎉
                  </div>
                  {/* / accordion-body */}
                </div>
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="minimal-headingThree">
                  <button
                    ...
                    aria-controls="minimal-collapseThree"
                  >
                    Can I print KOT in Hindi language?
                    <span>
                      <i className="fas fa-chevron-down" />
                    </span>
                  </button>
              ...
              <div className="accordion-item">
                <h2 className="accordion-header" id="minimal-headingThree">
                  <button
                    ...
                    aria-controls="minimal-collapseThree"
                  >
                    Can I manage my menu from Ciferon Merchant App?
                    <span>
                      <i className="fas fa-chevron-down" />
                    </span>
                  </button>
