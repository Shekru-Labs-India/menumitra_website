  ...
  return (
    <>
      <Helmet>
        ...
        <meta
          name="description"
          content="Comprehensive store management solutions for restaurants"
        />
        <meta
          name="keywords"
          content="Store Management, Restaurant Management, Menu Mitra, POS, Inventory Management"
        />
      </Helmet>
      <Header />
          ...
          <div className="container">
            <div className="row v-center">
              ...
              <div className="col-lg-7 tablet-lg-top-30">
                <h2 className="mb-30">Complete Store Management Solution</h2>
                <p className="mb-30">
                  Streamline your restaurant operations with our comprehensive
                  store management system. Manage inventory, track sales,
                  monitor staff performance, and optimize your business
          ...
          <div className="container">
            <div className="text-center">
              ...
              <p className="lead text-muted mb-5">
                Everything you need to manage your restaurant operations
                efficiently
              </p>
            </div>
                ...
                <div className="col-md-4 mb-4">
                  <div className="feature-card p-4 h-100 border-0 shadow-sm rounded-4">
                    <i
                      ...
                      className="fas fa-store feature-icon"
                    ></i>
                    <h5
                      style={{
                        fontWeight: 600,
                    ...
                    >
                      ...
                      dashboard. Monitor performance, inventory, and operations
                      across all your stores with centralized control.
                    </p>
                  </div>
                </div>
                <div className="col-md-4 mb-4">
                  <div className="feature-card p-4 h-100 border-0 shadow-sm rounded-4">
                    ...
                    <p
                      ...
                      className="feature-description"
                    >
                      Get instant insights into your store performance with
                      real-time analytics, sales reports, and business
                ...
                <div className="col-md-4 mb-4">
                  <div className="feature-card p-4 h-100 border-0 shadow-sm rounded-4">
                    <i
                      ...
                      className="fas fa-cogs feature-icon"
                    ></i>
                    <h5
                      style={{
                        fontWeight: 600,
                    ...
                    <p
                      ...
                      className="feature-description"
                    >
                      Automate routine tasks, inventory alerts, staff
                      scheduling, and operational workflows to improve
                ...
                <div className="col-md-4 mb-4">
                  <div className="feature-card p-4 h-100 border-0 shadow-sm rounded-4">
                    <i
                      ...
                      className="fas fa-mobile-alt feature-icon"
                    ></i>
                    <h5
                      style={{
                        fontWeight: 600,
                    ...
                    <p
                      ...
                      className="feature-description"
                    >
                      Access your store management tools anywhere with our
                      mobile app. Monitor operations, approve orders, and manage
                      staff on the go.
                    </p>
                  </div>
                </div>
                <div className="col-md-4 mb-4">
                  <div className="feature-card p-4 h-100 border-0 shadow-sm rounded-4">
                    ...
                    <p
                      ...
                      className="feature-description"
                    >
                      Ensure data security and compliance with industry
                      standards. Secure access controls, audit trails, and data
                      encryption.
                    </p>
                  </div>
                </div>
                <div className="col-md-4 mb-4">
                  <div className="feature-card p-4 h-100 border-0 shadow-sm rounded-4">
                    <i
                      ...
                      className="fas fa-headset feature-icon"
                    ></i>
                    <h5
                      style={{
                        fontWeight: 600,
                    ...
                    <p
                      ...
                      className="feature-description"
                    >
                      Get round-the-clock support for your store management
                      needs. Our dedicated team is always ready to help you
                      succeed.
                    </p>
                  </div>
                </div>
        ...
        <section className="py-5 bg-light">
          <div className="container">
            <div className="text-center mb-5">
              <h2 className="section-title mb-3">Advanced Store Operations</h2>
                  ...
                  <div className="operation-card-item">
                    <div className="d-flex align-items-start">
                      <div className="flex-shrink-0 me-4">
                        <div
                          className="bg-primary text-white rounded-circle d-flex align-items-center justify-content-center operation-icon"
                      ...
                      <div className="flex-grow-1">
                        ...
                        <p className="text-muted mb-0">
                          Seamlessly integrate with multiple POS terminals
                          across all stores. Centralized billing, payment
                ...
                <div className="col-6">
                  <div className="operation-card-item">
                    <div className="d-flex align-items-start">
                      <div className="flex-shrink-0 me-4">
                        <div
                          className="bg-success text-white rounded-circle d-flex align-items-center justify-content-center operation-icon"
                          style={{ width: "70px", height: "70px" }}
                        >
                      ...
                      <div className="flex-grow-1">
                        ...
                        <p className="text-muted mb-0">
                          ...
                          Automated stock alerts, supplier management, and waste
                          reduction.
                        </p>
                      </div>
                    </div>
              ...
              <div className="col-6">
                <div className="operation-card-item">
                  <div className="d-flex align-items-start">
                    <div className="flex-shrink-0 me-4">
                      <div
                        className="bg-warning text-white rounded-circle d-flex align-items-center justify-content-center operation-icon"
                        style={{ width: "70px", height: "70px" }}
                      >
                    ...
                    <div className="flex-grow-1">
                      ...
                      <p className="text-muted mb-0">
                        Manage staff across multiple locations with role-based
                        access, attendance tracking, and performance monitoring.
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <div className="col-6">
                <div className="operation-card-item">
                  <div className="d-flex align-items-start">
                    <div className="flex-shrink-0 me-4">
                      <div
                        className="bg-secondary text-white rounded-circle d-flex align-items-center justify-content-center operation-icon"
                        style={{ width: "70px", height: "70px" }}
                      >
                    ...
                    <div className="flex-grow-1">
                      ...
                      <p className="text-muted mb-0">
                        Efficiently handle dine-in, takeout, and delivery
                        orders. Kitchen display systems (KDS) and order routing.
                      </p>
                    </div>
                  </div>
                </div>
            ...
            <div className="row align-items-center">
              ...
              <div className="col-lg-6">
                ...
                <p className="lead mb-4">
                  ...
                  reporting tools designed for multi-store operations.
                </p>
            ...
            <div className="row g-4">
              <div className="col-md-4">
                <div className="text-center">
                  ...
                  <p className="text-white-50">
                    Connect with 100+ apps including Zomato, Swiggy, payment
              ...
              <div className="col-md-4">
                <div className="text-center">
                  ...
                  <p className="text-white-50">
                    Scale from single outlet to enterprise-level operations with
                    flexible pricing and feature packages.
                  </p>
                </div>
              </div>
              <div className="col-md-4">
                <div className="text-center">
                  ...
                  <p className="text-white-50">
                    Reliable cloud-based infrastructure ensures 99.9% uptime and
                    automatic backups.
                  </p>
                </div>
              </div>
            ...
            <div className="row align-items-center">
              <div className="col-lg-8">
                ...
                <p className="lead text-white-50 mb-0">
                  Join thousands of restaurants already using MenuMitra to
