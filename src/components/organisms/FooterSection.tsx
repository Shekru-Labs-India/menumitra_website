...
const FooterSection: React.FC<FooterSectionProps> = ({ className = '' }) => {
  ...
  return (
    <section className={`bg-white dark:bg-dark-300 overflow-hidden relative pt-20 border-t border-dashed border-gray-100 dark:border-borderColour-dark ${className}`}>
