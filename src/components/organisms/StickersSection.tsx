...
const stickers: Array<{ src: string; alt: string; preferredWidth: number }> = [
  {
    src: "/images/stickers/medal1.svg",
    alt: "High Performer",
    preferredWidth: 70,
  },
  {
    src: "/images/stickers/medal2.svg",
    alt: "Best Support",
    preferredWidth: 70,
  },
  { src: "/images/stickers/medal3.svg", alt: "Leader", preferredWidth: 70 },
  {
    src: "/images/stickers/medal4.svg",
    alt: "Easiest To Do Business With",
    preferredWidth: 70,
  },
  {
    src: "/images/stickers/medal-users-love-us.svg",
    alt: "Users Love Us",
    preferredWidth: 70,
  },
  {
    src: "/images/stickers/MomentumLeader.svg",
    alt: "Momentum Leader",
    preferredWidth: 100,
  },
  {
    src: "/images/stickers/Business_Leader.svg",
    alt: "Grid Leader",
    preferredWidth: 100,
  },
];
