        ...
        <div className="grid grid-cols-12 gap-8 items-center">
          ...
          <div className="col-span-12 md:col-span-6 ">
            <div className="relative w-full min-h-[530px] max-md:min-h-[400px] lg:ml-15">
              ...
              <div className="absolute max-lg:w-[220px] max-lg:aspect-video max-lg:!left-0 max-md:!top-5 !top-15 !-left-[40px] lg:!-top-[20px]">
              ...
              <div className="absolute max-lg:w-28 max-lg:aspect-square max-md:!left-[50px] max-md:!bottom-[70px] !bottom-[150px] !left-[50px] lg:!bottom-0 lg:!left-[45px] xl:!left-[85px]">
              ...
              <div className="absolute max-lg:w-[196px] !-right-5 !-bottom-0 max-md:!-bottom-5 max-md:!-right-5 lg:!not-sr-only-bottom-[45px] lg:right-0 xl:right-[30px]">
