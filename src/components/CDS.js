      ...
      <div className="container">
        ...
        <div className="row text-center">
            <div className="col-md-4 mb-4">
                ...
                <p style={{ color: '#666' }} className="feature-description">Ciferon's CDS allows you to display both online and dine-in orders immediately on your Customer screen, avoiding confusion.</p>
            </div>
            <div className="col-md-4 mb-4">
            ...
            <div className="col-md-4 mb-4">
                ...
                <p style={{ color: '#666' }} className="feature-description">Ciferon's CDS works flawlessly on both Android and Windows, allowing you to use whichever platform best suits you and your brand.</p>
            </div>
            <div className="col-md-4 mb-4">
