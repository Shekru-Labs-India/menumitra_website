    ...
    <div className="container">
      ...
      <div className="row h-center">
        <div className="col-lg-6 tablet-lg-top-30">
          <div
            className="accordion minimal-accordion rounded-4"
          ...
          >
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  Getting started with MenuMitra is super quick! Our onboarding
                  team is speedy, and all it takes is about 60 minutes to set up
                  your account. Just share the info we need, and you'll be good
                  to go on your MenuMitra adventure!
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  No worries! MenuMitra uses a cool hybrid technology that works
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  ...
                  hassles! It plays nice with all the printers out there in the
                  market, so you can use it seamlessly without any compatibility
                  issues. How cool is that?
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="col-lg-6 tablet-lg-top-30">
          ...
          >
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  ...
                  support team. They'll gladly assist you in updating your menu
                  whenever you need. We've got your back!
                </div>
              </div>
            </div>
            ...
            <div className="accordion-item">
              ...
              >
                <div className="accordion-body">
                  Count on it! MenuMitra's support is like your 24/7 superhero,
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://men4u.xyz/v2/website_api/create_booking",
        {
          method: "POST",
          headers: {
