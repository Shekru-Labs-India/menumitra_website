...
interface TargetCursorProps {
  ...
  spinDuration?: number;
  hideDefaultCursor?: boolean; // Currently not used - cursor only shows on target elements
}
...
const TargetCursor: React.FC<TargetCursorProps> = ({
  ...
  useEffect(() => {
    ...
    // Don't hide the default cursor globally - only show custom cursor over target elements
    ...
    const enterHandler = (e: MouseEvent) => {
      ...
      // Show the custom cursor when hovering over target elements
      ...
      const leaveHandler = () => {
        ...
        // Hide the custom cursor when leaving target elements
