...
const Footer = () => {
  ...
  return (
    <>
      <>
        <section className="footer-top-area  bg-white border border-top shadow-lg  pt-100 ">
            ...
            <div className="col-lg-12 col-sm-6 col-md-6 mb-5">
              <div className="single-widget pb-4">
                <div className="d-flex flex-column flex-sm-row align-items-center justify-content-between">
                  ...
                  {/* Book a Demo Button */}
                  <Link
                    className="btn btn-outline-dark ms-3 btn-sm p-2"
                    to="/book_demo"
                  >
                    Book a Demo
                  </Link>
              ...
              <div className="col-lg-4 col-sm-12 d-flex  flex-wrap">
                ...
                <div className="col-6 mb-3">
                  <div className="single-widget">
                    <h3 className="ms-3 text-info" style={{ fontSize: "19px" }}>
                      Utility
                    </h3>
                    <ul className="links">
                      <li className="mb-2">
                        <Link className="text-dark" to="/">
                          {" "}
                          <i className="fa-solid fa-check text-info me-1"></i>
                          Home
                        </Link>
                      </li>
                      <li className="mb-2">
              ...
              <div className="col-lg-3 col-sm-12 d-flex  flex-wrap">
                <div className="col-6 mb-3">
                  <div className="single-widget">
                    ...
                    <ul className="links">
                      <li className="mb-2">
                        <Link className="text-dark " to="/captainapp">
                          {" "}
                          <i className="fa-solid fa-check text-info me-1"></i>
                          Captain App
                        </Link>
                      ...
                      <li className="mb-2">
                        <Link className="text-dark " to="/waiterapp">
                          {" "}
                          <i className="fa-solid fa-check text-info me-1"></i>
                          Waiter App
                        </Link>
                      ...
                      <li className="mb-2">
                        <Link className="text-dark " to="/kds">
                          {" "}
                          <i className="fa-solid fa-check text-info me-1"></i>
                      ...
                      <li className="mb-2">
                        <Link className="text-dark " to="/cds">
                          {" "}
                          <i className="fa-solid fa-check text-info me-1"></i>
