  ...
  const mainContent = (
    <>
      ...
      <div className="bg-white rounded-medium p-2.5 shadow-nav">
        <img
          src="/images/restaurant-management.png"
          alt="MenuMitra Restaurant Management - Complete Restaurant Solution with all-in-one platform for restaurant management and operations"
      ...
      <YouTubeVideo 
        videoId="j2e2stCcICo"
        title="See Restaurant Management in Action"
        description="Watch how our system optimizes restaurant operations"
      />
