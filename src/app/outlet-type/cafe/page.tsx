      ...
      <main className="pt-20">
        <div className="container mx-auto px-4 py-16">
          <h1 className="text-4xl md:text-5xl font-bold leading-tight text-center mb-8">
            Cafe Management Solutions
          </h1>
          <p className="text-lg md:text-xl text-center text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
            Coffee shop and cafe management system with beverage customization, 
            loyalty programs, and efficient service for busy cafe environments.
          </p>
        </div>
      </main>
      <FooterSection />
